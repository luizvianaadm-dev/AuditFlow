        ...
        <div className="flex-1">
            ...
            <div className="flex space-x-1 border-b border-slate-200 mb-6 overflow-x-auto">
                ...
                <button
                    ...
                    className={`px-6 py-3 font-medium transition-colors border-b-2 flex items-center ${activeTab === 'trial_balance' ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                >
                ...
                <button
                    ...
                    className={`px-6 py-3 font-medium transition-colors border-b-2 ${activeTab === 'materiality' ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                >
                    Planejamento
                </button>
                <button
