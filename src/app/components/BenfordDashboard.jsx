    ...
    <div className="p-6 bg-gray-50 min-h-screen font-sans text-gray-800">
      <div className="max-w-7xl mx-auto flex flex-col gap-6">
        ...
        <div className="flex-1">
            ...
            {/* Tabs */}
            <div className="flex space-x-1 border-b border-slate-200 mb-6 overflow-x-auto whitespace-nowrap">
                {/* 1. Planning Phase */}
                <button
                    onClick={() => setActiveTab('materiality')}
                    className={`px-4 py-3 font-medium transition-colors border-b-2 ${activeTab === 'materiality' ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                >
                    1. Planejamento & Materialidade
                </button>

                {/* 2. Execution Phase (Tests) */}
                <button
                    onClick={() => setActiveTab('trial_balance')}
                    className={`px-4 py-3 font-medium transition-colors border-b-2 flex items-center ${activeTab === 'trial_balance' ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                >
                    2. Balancete
                </button>
                ...
                <button
                    ...
                    className={`px-4 py-3 font-medium transition-colors border-b-2 ${activeTab === 'analysis' ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                >
                    3. Análise de Risco (Benford)
                </button>

                <button
                    onClick={() => setActiveTab('sampling')}
                    className={`px-4 py-3 font-medium transition-colors border-b-2 ${activeTab === 'sampling' ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                >
                    4. Amostragem
                </button>
                ...
                <button
                    ...
                    className={`px-4 py-3 font-medium transition-colors border-b-2 ${activeTab === 'circularization' ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                >
                    5. Circularização
                </button>
                ...
                <button
                    ...
                    className={`px-4 py-3 font-medium transition-colors border-b-2 ${activeTab === 'payroll' ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                >
                    6. Teste de Folha
                </button>
                ...
                <button
                    ...
                    className={`px-4 py-3 font-medium transition-colors border-b-2 flex items-center ${activeTab === 'workpapers' ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                >
                ...
                <button
                    ...
                    className={`px-4 py-3 font-medium transition-colors border-b-2 flex items-center ${activeTab === 'summary' ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                >
                    8. Sumário de Erros
                </button>
                ...
                <button
                    ...
                    className={`px-4 py-3 font-medium transition-colors border-b-2 ${activeTab === 'history' ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                >
                    Histórico
                </button>
            </div>
            ...
            {activeTab === 'trial_balance' && (
                <TrialBalanceView engagementId={engagement.id} />
            )}
