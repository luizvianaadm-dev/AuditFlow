  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow">
      ...
      <p className="text-gray-600 mb-6 text-sm">
        Faça o upload do seu arquivo bruto (.csv) para padronizar colunas e remover linhas inválidas antes de iniciar o mapeamento.
      </p>
      ...
      <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center mb-6 hover:bg-gray-50 transition-colors">
        ...
        <label htmlFor="cleaning-upload" className="cursor-pointer flex flex-col items-center">
            ...
            <span className="text-primary font-medium">Clique para selecionar o CSV bruto</span>
