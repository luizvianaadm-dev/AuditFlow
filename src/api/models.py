...
class AuditFirm(Base):
    ...
    certificates = relationship("DigitalCertificate", back_populates="firm")
...
class Engagement(Base):
    ...
    trial_balance_entries = relationship("TrialBalanceEntry", back_populates="engagement")
...
class DigitalCertificate(Base):
    ...
    firm = relationship("AuditFirm", back_populates="certificates")
...
class TrialBalanceEntry(Base):
    ...
    engagement = relationship("Engagement", back_populates="trial_balance_entries")
